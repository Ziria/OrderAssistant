...
////    if (btnChoice==1) {
////        NSArray *array1 = [[NSArray alloc] initWithObjects:@"1", @"5", @"6",@"8", nil];
////        self.myPickerData1=array1;
////    }else if (btnChoice==2) {
////    
////        NSArray *array2 = [[NSArray alloc] initWithObjects:@"朋友聚会",@"家庭聚会",@"情侣约会",@"商务用餐",@"公司年会",@"唔要吃推荐", nil];
////        self.myPickerData1=array2;
////        
////    }
//    NSArray *array1 = [[NSArray alloc] initWithObjects:@"0.5",@"1", @"5", @"6",@"8", nil];
//    self.myPickerData1=array1;
//}
...
//                 subPickDateArray, [pickDateArray objectAtIndex:0],
//                 [NSArray arrayWithObjects:@"花",@"草",@"葵花",            nil], @"植物",
//                 [NSArray arrayWithObjects:@"疯狂的石头",@"花岗岩",@"鹅卵石", nil], @"石头",nil];
//    
//    subPickDateArray = [dicPicker objectForKey:[pickDateArray objectAtIndex:0]];
...
//        currentPage=1;
//        pageNow=[NSString stringWithFormat:@"%d",currentPage];
//        distantLable.text = distantText;
//        resentities=[WebServices getNearShopForIOS:pageNow :pageSize :curLad :curLgd :distantLable.text];
//        
//        [self.tableviewCustom reloadData];
//        tableviewCustom.contentOffset = CGPointMake(0, 0);
//        
...
//        currentPage=1;
//        pageNow=[NSString stringWithFormat:@"%d",currentPage];
//        hotelLable.text=hotelText;
//
//        if (btnChoiceKindRow==5) {
//            resentities=[WebServices getShopDetailInfoByIsRecommedForIOS:pageNow :pageSize];
//            
//        }else{
//            resentities=[WebServices getShopsForIOS:pageNow :pageSize :shopKindCode];
//            
//        }
//        [self.tableviewCustom reloadData];
//        tableviewCustom.contentOffset = CGPointMake(0, 0);
//    }
    currentPage=1;
    pageNow=[NSString stringWithFormat:@"%d",currentPage];
    distanceLable.text = distantText;
//    resentities=[WebServices getNearShopForIOS:pageNow :pageSize :curLad :curLgd :distantLable.text];
//    
//    [self.tableviewCustom reloadData];
//    tableviewCustom.contentOffset = CGPointMake(0, 0);
...
{   //当你按下这个按钮的时候, 意味着你需要看下一页了, 因此当前页码加1
    ...
    pageNow=[NSString stringWithFormat:@"%d",currentPage];
//    if (btnChoice==1) {
//        NSMutableArray *more=[WebServices getNearShopForIOS:pageNow :pageSize :curLad :curLgd :distantText];
//        [self performSelectorOnMainThread:@selector(appendTableWith:) withObject:more waitUntilDone:NO];
//    }else{
//        if (btnChoiceKindRow==5) {
//            NSMutableArray *more=[WebServices getShopDetailInfoByIsRecommedForIOS :pageNow :pageSize ];
//            [self performSelectorOnMainThread:@selector(appendTableWith:) withObject:more waitUntilDone:NO];
//        }else{
//            NSMutableArray *more=[WebServices getShopsForIOS:pageNow :pageSize :shopKindCode];
//            [self performSelectorOnMainThread:@selector(appendTableWith:) withObject:more waitUntilDone:NO];
//        }
//    
//    }
    ...
    if ([shopType isEqualToString:@"1"]) {
        ...
        if (shopListCode!=nil) {
            NSMutableArray *more=[WebServices getShopsForIOS:pageNow :pageSize :shopListCode];
            [self performSelectorOnMainThread:@selector(appendTableWith:) withObject:more waitUntilDone:NO];
        }else{
            NSMutableArray *more=[WebServices getShopDetailInfoByIsRecommedForIOS:pageNow :pageSize];
            [self performSelectorOnMainThread:@selector(appendTableWith:) withObject:more waitUntilDone:NO];
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component
{
    ...
    else if(pickerView==picker_area)
    {
        ...
        if (component==0) {
            ...
            NSLog(@"%d",[subPickDateArray count]);
        }
