...
+ (NSString *) scanBarcode:(NSString *) cCode withEventCode:(NSString *) etCode withShopCode:(NSString *) sdCode withIsChange:(NSString *) flag {
    ...
    NSString *soapMessage = [NSString stringWithFormat:@"<?xml version=\"1.0\" encoding=\"utf-8\"?>\
                             ...
                             </soap:Envelope>", cCode, etCode, sdCode, flag];
    NSString *msgLength = [NSString stringWithFormat:@"%d", [soapMessage length]];
